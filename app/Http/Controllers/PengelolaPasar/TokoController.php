      ...
      public function datatokojson(){
        ...
        ->addColumn('action', function($query){
            ...
            if($query->status == 'on'){
                ...
                <a href="'.url('pengelola/toko/jam/'.$query->id_pedagang).'" data-toggle="tooltip" title="Jam Toko" data-placement="top"><span class="badge badge-info"><i class="fas fa-cog"></i></span></a>

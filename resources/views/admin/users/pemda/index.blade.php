        ...
        <form id="tambahform">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama_pemda" placeholder="Nama Customer" required>
                    </div>
                </div>  
            ...
            <form id="editform">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label for="nama_pemda" class="col-sm-2 col-form-label">Nama</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_pemda" id="nama_pemda" placeholder="Nama Pengelola" required>
                        </div>
                    </div>  

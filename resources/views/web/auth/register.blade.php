    ...
    <div class="container-fluid">
        <div class="row overflow-hidden">
            ...
            <div class="col-12 col-lg-4 mt-4 mt-xl-5 mb-4" id="login-section">
                ...
                <form action="{{ url('register') }}" class="bg-white p-3 p-xl-5 login-form" id="form-section"
                    method="POST">
                    @csrf
                    ...
                    <div class="mb-2 mb-xl-3">
                        ...
                        <input placeholder="Nama" type="text" class="form-control py-2 border-r-sip" id="nama"
                            name="nama_customer" aria-describedby="nama" value="{{ old('nama_customer') }}">
                        @if ($errors->has('nama_customer'))
                            <div class="text-danger text-small">
                                @foreach ($errors->get('nama_customer') as $err)
                                    {{ $err }}
                                @endforeach
                            </div>
                        @endif
                    ...
                    <div class="mb-2 mb-xl-3">
                        ...
                        <input placeholder="Masukan Email Anda" type="text" class="form-control py-2 border-r-sip"
                            id="inputEmailTelp" name="email_customer" value="{{ old('email_customer') }}">

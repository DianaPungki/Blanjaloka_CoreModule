        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <form action="{{url('sellers/produk')}}" method="get">
                        <div class="card-header bg-white">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select" required name="id_pasar" onchange="this.form.submit()">
                                        <option selected value="">- PILIH KATEGORI PASAR -</option>
                                        @foreach($pasar as $p)
                                            @if($p->id_pasar == @$_GET['id_pasar']):
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover" id="gudangtable">
                            <thead>
                                <tr>

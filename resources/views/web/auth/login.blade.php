    ...
    <div class="container-fluid">
        <div class="row overflow-hidden">
            ...
            <div class="col-12 col-lg-5 mt-4 mt-xl-5 mb-4 ms-lg-auto" id="login-section">
                ...
                <form action="{{url('login')}}" class="bg-white p-3 p-xl-5 " id="form-section" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        <input placeholder="Contoh: email@blanjaloka.com" value="{{old('email_customer')}}" type="text" class="form-control py-3 border-r-sip mt-2" name="email_customer" id="exampleInputEmail1" aria-describedby="emailHelp">
                        @if($errors->has('email_customer'))
                            <div class="text-danger text-small">
                                @foreach($errors->get('email_customer') as $err)
                                    {{$err}}
                                @endforeach
                            </div>
                        @endif

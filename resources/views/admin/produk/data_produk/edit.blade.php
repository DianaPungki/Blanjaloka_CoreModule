        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{url('admin/produk')}}">Produk Saya</a></li>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" required name="id_pedagang" id="id_pedagang">
                                    ...
                                    @foreach($pedagang as $k)
                                        @if($p->id_pedagang == $k->id_pedagang)
                                            <option selected value="{{$k->id_pedagang}}">- {{$k->nama_pedagang}}</option>
                                        @else
                                            <option value="{{$k->id_pedagang}}">- {{$k->nama_pedagang}}</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="custom-select" required name="id_kategori" id="id_kategori">
                                    ...
                                    @foreach($kategori as $k)
                                        @if($p->id_kategori == $k->id_kategori)
                                            <option selected value="{{$k->id_kategori}}">- {{$k->jenis_kategori}}</option>
                                        @else
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <select name="satuan" id="" required class="form-control input-group-text bg-white">
                                            ...
                                            @endforeach --}}
                                            <option value="Pcs" {{ $p->satuan === 'Pcs' ? 'selected' : '' }}>Pcs</option>
                                            <option value="Gram" {{ $p->satuan === 'Gram' ? 'selected' : '' }}>Gram</option>
                                            <option value="Kilo Gram" {{ $p->satuan === 'Kilo Gram' ? 'selected' : '' }}>Kilo Gram</option>
                                            <option value="Liter" {{ $p->satuan === 'Liter' ? 'selected' : '' }}>Liter</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="harga_jual" id="harga_jual" placeholder="Harga Produk" required value="{{$p->harga_jual}}">
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('#diskon').on('keyup', function(e){
        ...
        var harga = parseInt($('#harga_jual').val().split(",").join(""));
        ...
        .then((willDelete) => {
            if(willDelete) {
                $.ajax({
                    ...
                    url: "{{ url('admin/produk/delete/foto') }}",
                    type: "POST",
                    success: function(e){
                        location.reload();
                    }
